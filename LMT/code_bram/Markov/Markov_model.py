...
from scripts.tools.select_db import connection_list_events_in_time_frame
...
def calculate_state_change(file):
    ...
    list_events = ['Group 3 break', 'Group 4 break', 'Group 3 make','Group 4 make','Contact','Break contact','Group2','Group3','Group4']
    start_time = [22, 0, 0]
    end_time = [22, 59, 0]
    ...
    for event in animal:
        try:
            if event[0] in list_events:
                if animal[i + 1][0] in list_events:
